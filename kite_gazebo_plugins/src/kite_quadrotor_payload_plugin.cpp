#include "kite_gazebo_plugins/kite_quadrotor_payload_plugin.h"

namespace kite_ros {

KITEQuadrotorPayloadPlugin::KITEQuadrotorPayloadPlugin(std::string name)
    : KITEQuadrotorPlugin(std::move(name)) {}
