#ifndef KITE_ROS_KITE_CONTROL_TRAJECTORY_H_
#define KITE_ROS_KITE_CONTROL_TRAJECTORY_H_

#include <cmath>
#include <eigen3/Eigen/Dense>
#include <vector>
#include "kite_control/data_types.h"

namespace kite_ros::trajectory {
class Trajectory {
public:
...
#endif // KITE_ROS_KITE_CONTROL_TRAJECTORY_H_